...
class CustomPlanarWalker(walker.PlanarWalker):
    ...
    def get_reward(self, physics): 
        ...
        if physics.time() < 0.03: 
            ...
            self.left_time = 0 
            self.right_time = 0 
            self.last_x_left_foot = -0.002
            self.last_x_right_foot = -0.002
        ...
        #print("walk_std:",walk_std,"alternate_legs:",alternate_legs,"move_reward:",move_reward,"stand_reward:",stand_reward,"upright:",upright) 
        return alternate_legs*walk_std*reward_torso
    ...
    #     zero_neighbor_down = -0.12
    #     if self.left_dominant:
    #         if angle_left_thigh> math.radians(20) and angle_right_thigh<math.radians(-25) and angle_left_leg > zero_neighbor_down and angle_left_leg < zero_neighbor_up:
    #             self.left_dominant = False
    #             self.changes += 1
    #             left_reward += 1*self.changes
    #             right_reward += 1*self.changes
    #         else:
    #             if angle_left_thigh > self.last_left_thigh_angle:
    #                 self.last_left_thigh_angle = angle_left_thigh
    #                 left_reward += good_moves*self.changes
    #             if angle_right_thigh < self.last_right_thigh_angle:
    #                 self.last_right_thigh_angle = angle_right_thigh
    #                 right_reward += good_moves*self.changes
                
                
    #     else:
    #         if angle_right_thigh>math.radians(20) and angle_left_thigh<math.radians(-25) and angle_right_leg > zero_neighbor_down and angle_right_leg < zero_neighbor_up:
    #             self.left_dominant = True  
    #             self.changes += 1
    #             left_reward += 1*self.changes
    #             right_reward+= 1*self.changes
    ...
    #     if(left_reward==0 or right_reward==0):
    #         left_reward = 0
    #         right_reward = 0

    #     alternate_legs = self.changes
    #     # if(alternate_legs==1):
    #     #     alternate_legs = 5
    #     # else:
    #     #     alternate_legs = ((1 + 3*alternate_legs) / 4)
    ...
    #     return walk_std*alternate_legs*reward_torso*action_cost
